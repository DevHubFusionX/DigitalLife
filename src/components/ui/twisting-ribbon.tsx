...
export function TwistingRibbon({
  ...
  useEffect(() => {
    ...
    const L_COLOR_FACE = lightColors?.face ? hexToRgb(lightColors.face) : [255, 209, 72]; // Use gold as face color
    const L_COLOR_FOLD_A = lightColors?.foldA ? hexToRgb(lightColors.foldA) : [245, 158, 11];
    const L_COLOR_FOLD_B = lightColors?.foldB ? hexToRgb(lightColors.foldB) : [217, 119, 6];
    const L_COLOR_FOLD_C = lightColors?.foldC ? hexToRgb(lightColors.foldC) : [180, 83, 9];
    ...
    // Dark Mode Colors
    const D_COLOR_FACE = darkColors?.face ? hexToRgb(darkColors.face) : [255, 209, 72];
    const D_COLOR_FOLD_A = darkColors?.foldA ? hexToRgb(darkColors.foldA) : [245, 158, 11];
    const D_COLOR_FOLD_B = darkColors?.foldB ? hexToRgb(darkColors.foldB) : [217, 119, 6];
    const D_COLOR_FOLD_C = darkColors?.foldC ? hexToRgb(darkColors.foldC) : [180, 83, 9];
